...
export default function RapidFireAddition() {
  ...
  const inputClass =
    "border-2 border-indigo-300 dark:border-indigo-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400 text-2xl w-28 text-center bg-gray-50 dark:bg-neutral-800 text-gray-800 dark:text-gray-100 transition-all duration-200";
  const buttonClass =
